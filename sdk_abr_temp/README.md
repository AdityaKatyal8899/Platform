...
- **Production-ready** — the upload/result engine already handles arbitrary segment counts, so
  adding a rendition ladder later is a localized FFmpeg change.
...
| Delivery | `CDN_URL`, `DELIVERY_URL_TEMPLATE` | `{cdn}/videos/{video_id}/stream.m3u8` |
...
- **HLS transcoding** — easy FFmpeg add; architecture already supports it.
